...
class SettingTestCase(flask_unittest.ClientTestCase):
    ...
    def test_get(self, client):
        request = client.get('http://127.0.0.1:5000/setting/', query_string=self.args,
    ...
    def test_put_pk(self, client):
        ...
        request = client.put('http://127.0.0.1:5000/setting/',
